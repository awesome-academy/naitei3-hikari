                                ...
                                <div className="card-body grid-showcase">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-4 offset-md-4">
                                            <span>.col-md-4 .offset-md-4</span></div>
                                    </div>
                                    <div className="row">
                                        <div className="col-md-3 offset-md-3">
                                            <span>.col-md-3 .offset-md-3</span></div>
                                        <div className="col-md-3 offset-md-3">
                                            <span>.col-md-3 .offset-md-3</span></div>
                                    </div>
                                    <div className="row">
                                        <div className="col-md-6 offset-md-3">
                                            <span>.col-md-6 .offset-md-3</span></div>
                                    </div>
                                    <div className="row">
                                        <div className="col-sm-5 col-md-6">
                                            <span>.col-sm-5 .col-md-6</span></div>
                                        <div className="col-sm-5 offset-sm-2 col-md-6 offset-md-0">
                                            <span>.col-sm-5 .offset-sm-2 .col-md-6 .offset-md-0</span></div>
                                    </div>

                                    <div className="row">
                                        <div className="col-sm-6 col-md-5 col-lg-6">
                                            <span>.col-sm-6 .col-md-5 .col-lg-6</span></div>
                                        <div className="col-sm-6 col-md-5 offset-md-2 col-lg-6 offset-lg-0">
                                            <span>.col-sm-6 .col-md-5 .offset-md-2 .col-lg-6 .offset-lg-0</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
