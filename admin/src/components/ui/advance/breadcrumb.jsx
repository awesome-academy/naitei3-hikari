...
class Breadcrumbs extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Breadcrumb title="Breadcrumbs" parent="Advance"/>
                    ...
                    <div className="row">
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <ol className="breadcrumb bg-white m-b-0 p-b-0 p-l-0">
                                        <li className="breadcrumb-item"><a href="javascript:void(0)"><i
                        ...
                        <div className="col-sm-12">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <nav className="breadcrumb m-b-0">
                                        <a className="breadcrumb-item" href="javascript:void(0)">Home</a>
                                        <a className="breadcrumb-item" href="javascript:void(0)">Library</a>
