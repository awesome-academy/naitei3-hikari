                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-xl-4 col-lg-6">
                            <div className="card custom-card general-user-card">
                                <div className="card-header">
                                    <img src={require('../../assets/images/user-card/1.jpg')} className="img-fluid"
                                         alt=""/>
                                </div>
                                <div className="card-profile">
                                    <img src={require('../../assets/images/avtar/3.jpg')} className="rounded-circle"
                                         alt=""/>
                                </div>
                                ...
                                <div className="card-body">
                                    <Slider {...settings}>
                                        <div className="item">
                                            ...
                                            <img src={require('../../assets/images/dashboard/boy-2.png')}
