...
class Default extends Component {
    ...
    render(){
        const data = [
            {                                   
                color: "#4099ff", 
                points: [{x: 0, y: 10}, {x: 10, y: 20}, {x: 20, y: 40}, {x: 30, y: 30}, {x: 40, y: 0}, {x: 50, y: 20}, {x: 60, y: 10}, {x: 70, y: 30}, {x: 80, y: 10}] 
            },{                                   
                color: "#FF5370", 
                points: [{x: 0, y: 20}, {x: 10, y: 40}, {x: 20, y: 10}, {x: 30, y: 20}, {x: 40, y: 40}, {x: 50, y: 30}, {x: 60, y: 40}, {x: 70, y: 10}, {x: 80, y: 20}] 
            },{                                   
                color: "#26c6da", 
                points: [{x: 0, y: 10}, {x: 10, y: 60}, {x: 20, y: 10}, {x: 30, y: 40}, {x: 40, y: 30}, {x: 50, y: 80}, {x: 60, y: 30}, {x: 70, y: 20}, {x: 80, y: 90}] 
            }
        ];
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <div className="dashboard-chart-container sales-overview-chart">
                                        <Sparklines data= {[24, 27, 8, 18, 12, 8, 40, 33, 37, 25, 22, 18, 25, 2, 4, 15, 10, 11, 15, 14, 6, 8, 6, 8, 30, 25]} >
                                                        ...
                                                        <div><p className="text-center">I must explain to you how all this mistaken
                                                            ...
                                                            <div className="text-center">
                                                                <div className="media d-inline-flex">
                                                                    <img className="mr-3 img-60" src={require('../../assets/images/dashboard/boy-1.png')} alt="Generic placeholder image"/>
